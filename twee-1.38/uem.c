...
word right		^F	undo			^U
goto line begin	^[	write file		^W
goto line end	^]	look for string	^L
pgdown			^C	jmp to line		^J
pgup			^R	quit			^Q
*/
...
void redraw()
{
	...
	gotoxy(1,1);
	clrtoeol();
	sprintf(status, "  %6d %5d %c %02x ", l, col+1, \
